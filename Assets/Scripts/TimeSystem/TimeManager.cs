...
public class TimeManager : SingletonMonobehaviour<TimeManager>, ISaveable
{
    ...
    public GameObjectSave ISaveableSave()
    {
        ...
        sceneSave.stringDictionary.Add("gameMonth", gameMonth.ToString());
        ...
        if (gameSave.gameObjectData.TryGetValue(ISaveableUniqueID, out GameObjectSave gameObjectSave))
        {
            ...
            if (GameObjectSave.sceneData.TryGetValue(Settings.PersistentScene, out SceneSave sceneSave))
            {
                ...
                if (sceneSave.intDictionary != null && sceneSave.stringDictionary != null)
                {
                    ...
                    if (sceneSave.stringDictionary.TryGetValue("gameMonth", out string savedGameMonth))
                    {
                        if (Enum.TryParse<Month>(savedGameMonth, out Month month))
                        {
                            gameMonth = month;
                        }
                    }
